...
- Transcribe handwritten signature names CAREFULLY, letter by letter, and copy the same spelling wherever legible (e.g. a stamped or printed name elsewhere in the entry). If the handwriting is genuinely illegible, leave `author.name` empty - never guess a name from partial strokes.
